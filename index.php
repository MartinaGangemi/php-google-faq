...
<body>
    <header>
        <div class="d-flex align-items-center p-4 box-logo">
            <img height="25" src="https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_92x30dp.png" alt="">
            <h4 class="ms-4 mb-1 ">Privacy e termini</h4>
        </div>
        <nav>
            <ul>
    ...
    <main class="container mt-5">
        <?php foreach($faq as $key => $item):?>
            <section>
                <h3 class="mt-5 mb-3"><?php echo $item["question"] ?></h3>
                <p><?php echo  nl2br($item["answer"]) ?></p>
            </section>
        <?php endforeach ?>
    </main>
</body>
